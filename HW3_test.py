...
def test_words_containing():
    ...
    list2 = ["people", "who", "on", "world", "people", "who", "look", "for", "cannot"]
    i = 0
    while (i < len(list1)):
        if list1[i] == list2[i]:
            i = i + 1
...
if __name__ == "__main__":
    ...
    parser.add_argument('-u', '--unique', help="Flag to test the unique function from HW3", action="store_true")
    parser.add_argument('-w', '--works', help="Flag to test the words_containing function from HW3", action="store_true")
    parser.add_argument('-l', '--len', help="Flag to test the len_safe function from HW3", action="store_true")
